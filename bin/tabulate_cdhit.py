...
"""
TAKEN FROM https://github.com/wanyuac/PAMmaker/blob/master/utility/tabulate_cdhit.py
...
Command:
    python tabulate_cd-hit.py -i CDS.clstr > CDS_clusters.tsv
...
def parse_argument():
    ...
    parser.add_argument("-i", "--input", dest = "i", type = str, required = True, help = "Input clstr file from cd-hit/cd-hit-est")
    parser.add_argument("-e", "--cd_hit_est", dest = "e", action = "store_true", help = "Flag it when the input clstr file is produced by cd-hit-est")
